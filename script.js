document.getElementById("loginForm").addEventListener("submit", function(event) {
    ...
    const documento = document.getElementById("numeroDocumento").value; // Tipo de Documento
    ...
    if (senha.trim() === senhaCorreta && documento.trim() !== "") {
        ...
        if (usuario === "paciente") {
            ...
            window.location.href = "Profissional/planoAlimentar1P.html";  // Redireciona para a página do paciente
